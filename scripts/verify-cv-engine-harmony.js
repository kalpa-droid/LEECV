...
if (fs.existsSync(cvContextPath)) {
  ...
  check(
    ...
    (contextContent.includes('setCvData((prev: CVData) =>') || contextContent.includes('setCvDataState((prev: CVData) =>')) && contextContent.includes('id: res.record!.id') && contextContent.includes('saveCVAs'),
