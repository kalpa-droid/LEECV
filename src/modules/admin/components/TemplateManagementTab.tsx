            ...
            return (
              <button
                ...
                className={`p-3 rounded-2xl border text-left transition cursor-pointer flex flex-col justify-between ${
                  isSelected
                    ? 'border-[var(--color-accent-base)] bg-rose-50/50 shadow-md ring-2 ring-rose-200'
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 rounded-xl border border-slate-300 bg-white font-bold text-slate-900 outline-none focus:border-[var(--color-accent-base)]"
                />
              </div>
