...
export function PublicCVView({ slugInput }: PublicCVViewProps) {
    ...
    return (
      <div className="h-screen bg-[#1F1322] flex flex-col items-center justify-center text-white p-6 text-center">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-[#FF2E63] hover:bg-[#E31555] text-white font-black text-xs rounded-xl shadow-lg transition"
        >
  ...
  return (
    <div className="h-screen bg-[#1F1322] text-white flex flex-col font-sans overflow-hidden">
      {/* Public Header Bar */}
      <header className="bg-[#2B1B2E] border-b border-purple-500/30 px-4 py-3 flex items-center justify-between z-30 shadow-lg shrink-0">
