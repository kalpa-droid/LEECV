...
export default function CloudStatusModal({
  ...
  return (
        ...
        <div className="w-full flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-3.5 py-2 bg-[var(--color-status-success-base)] hover:opacity-90 text-white font-extrabold text-xs rounded-[${radius.card}] ${elevationSystem.floating} transition flex items-center gap-1.5 cursor-pointer`}
            >
          ...
          <button
            onClick={onClose}
            className={`px-3 py-2 bg-white/10 hover:bg-white/20 text-white font-bold text-xs rounded-[${radius.card}] transition cursor-pointer`}
          >
            Cerrar
          </button>
        </div>
    ...
    >
      <div className={`space-y-4 text-xs bg-[var(--ui-bg-dock)] p-4 rounded-[${radius.modal}] text-white`}>
        ...
        <div className={`p-4 rounded-[${radius.modal}] bg-[var(--ui-bg-dock)] border border-white/10 space-y-3`}>
          ...
          {profile?.drive_connected ? (
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className={`w-full py-2 px-3 rounded-[${radius.card}] bg-[var(--color-secondary-base)] hover:opacity-90 text-white font-extrabold text-xs flex items-center justify-center gap-2 transition ${elevationSystem.raised} cursor-pointer`}
              >
        ...
        <div className="space-y-2 border-t border-white/10 pt-3">
          ...
          <div className="space-y-2">
            <div className={`flex items-center gap-3 p-2.5 rounded-[${radius.card}] bg-[var(--ui-bg-dock)] border border-white/10`}>
