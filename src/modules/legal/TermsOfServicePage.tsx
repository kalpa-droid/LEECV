    ...
    <div className="min-h-screen bg-[var(--ui-bg-panel)] text-[var(--ui-text-primary)] font-sans flex flex-col">
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <FileText className="w-5 h-5 text-[var(--color-status-success-text)]" />
              <span className="font-black text-sm tracking-tight">LEECV — Términos de Servicio</span>
            </div>
          </div>
          <a
            href="/"
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-4 sm:p-6 lg:p-8">
        <div className={`bg-[var(--ui-bg-card)] border border-[var(--ui-border)] rounded-[${radius.modal}] p-6 sm:p-8 ${elevationSystem.overlay}`}>
          <h1 className="text-xl font-black mb-1 text-[var(--ui-text-primary)]">Términos de Servicio y Condiciones de Uso</h1>
