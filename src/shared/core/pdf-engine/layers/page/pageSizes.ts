...
export const PAGE_SIZES: Record<string, PageSize> = {
  ...
  tarjeta_estandar: definePageSize({ id: 'tarjeta_estandar', name: 'Estándar AR/US', widthMm: 89, heightMm: 51, label: 'Estándar AR/US (89 × 51 mm)', category: 'tarjeta' }),
  ...
  tarjeta_japonesa: definePageSize({ id: 'tarjeta_japonesa', name: 'Japonesa (Meishi)', widthMm: 91, heightMm: 55, label: 'Japonesa Meishi (91 × 55 mm)', category: 'tarjeta' }),
  tarjeta_china: definePageSize({ id: 'tarjeta_china', name: 'China / HK / SG', widthMm: 90, heightMm: 54, label: 'China / HK / SG (90 × 54 mm)', category: 'tarjeta' }),
  tarjeta_brasilera: definePageSize({ id: 'tarjeta_brasilera', name: 'Brasil / MX / LATAM', widthMm: 90, heightMm: 50, label: 'Brasil / MX (90 × 50 mm)', category: 'tarjeta' }),
