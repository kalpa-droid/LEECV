...
export interface TemplateRendererProps {
  preset: Preset;
  atsMode?: boolean;
  sections: ContentSection<CvRecordKind>[];
  personalInfo?: any;
...
export const TemplateRenderer: React.FC<TemplateRendererProps> = ({
  ...
  const renderRecord = (
    rec: ContentRecord<CvRecordKind>, 
    ...
    const renderer = CV_RECORD_RENDERERS[rec.kind];
    if (renderer) {
      return renderer(rec, ctx);
    }
    return null;
  };
  ...
  const buildDocumentBody = (pageSections: ContentSection<CvRecordKind>[], isFirstPage: boolean) => (
